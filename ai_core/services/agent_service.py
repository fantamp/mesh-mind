...
from ai_core.common.models import DomainMessage, Document

@standard_retry
def run_summarizer(chat_id: str, messages: List[DomainMessage], instruction: str = None, user_id: str = "system") -> str:
    """
    ...
    """
    logger.info(f"Running summarizer for chat_id={chat_id}, msg_count={len(messages)}")
    ...
    base_instruction = f"Please summarize the following chat history for chat_id='{chat_id}':\n\n{messages_text}"
